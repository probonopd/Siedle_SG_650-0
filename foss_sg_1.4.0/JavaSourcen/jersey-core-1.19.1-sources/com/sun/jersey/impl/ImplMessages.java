...
public final class ImplMessages {
    ...
    public static Localizable localizableERROR_CREATING_DEFAULT_WADL_GENERATOR() {
        return messageFactory.getMessage("error.creating.default.wadl.generator");
    }

    /**
     * An error occurred when creating default WADL generator.
     * 
     */
    public static String ERROR_CREATING_DEFAULT_WADL_GENERATOR() {
        return localizer.localize(localizableERROR_CREATING_DEFAULT_WADL_GENERATOR());
    }
